...
The code defining the noise and the noisy signal can be found in section \textsc{Noise line 11-14} and plotting is in section \textsc{FIGURE 2.5 line 59-64}
\begin{figure}[H]
        \centering
...
section \textsc{Figure 2 line 47-57}.
\begin{figure}[H]
        \centering
...
\subsection*{e}
For this section we look at the code in section \textsc{MATRIX B line 26-32} and \textsc{Figure 3 line 67-77}.
\begin{figure}[H]
        \centering
...
This next figures is covered by section \textsc{FIGURE 4 line 78-84}
\begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{Figure_4.png}
        \caption{The reduced noise with matrix B for two different noise realizations.}
\end{figure}
...
# FIGURE 2 - comparing signal with noise to reduced noise (with A)
