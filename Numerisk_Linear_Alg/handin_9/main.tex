...
\subsection*{(c)Finding the EigenValues and EigenVectors as an Atheist}

\textcolor{red}{Given the matrix $A$ 
\begin{equation*}
    A = \begin{bmatrix}
        -0.15 & 0.15 \\
        0.15 & -0.45
...
\[
\det(A-\lambda I_2) = \begin{bmatrix}
        -0.15- \lambda & 0.15 \\
        0.15 & -0.45 - \lambda
    \end{bmatrix} = \lambda^2 + 0.60\lambda + 0.045
\]
Using the quadratic formula to do stuff (find the concrete eigenvalues)
\[
\lambda = \frac{-0.60 \pm \sqrt{0.60^2 - 4(1)(0.045)}}{2(1)} = \frac{-0.60 \pm \sqrt{0.18}}{2} = \frac{-0.60 \pm 0.42}{2}
\]
This gives the eigenvalues:
\begin{equation} \label{EigVal}
    \lambda_0 = -0.09 \qquad \lambda_1 = -0.51
\end{equation}
Let's find the corresponding eigenvectors, starting with $\lambda_0$.
\begin{equation*}
    (A - \lambda_0 I_2)v_0 = \begin{bmatrix}
        -0.06 & 0.15 \\
        0.15 & -0.36
    \end{bmatrix}v_0 = 0
\end{equation*}
 which gives us the eigenvector $v_0$ (after normalizing it).
\begin{equation*}
    v_0 = \begin{bmatrix}
        0.92 \\
        0.38
...
Now for $\lambda_1$.
\begin{equation*}
    (A - \lambda_1 I_2)v_1 = \begin{bmatrix}
        0.36 & 0.15 \\
        0.15 & 0.06
    \end{bmatrix}v_1 = 0
\end{equation*}
which gives us the eigenvector $v_1$ (after normalizing it).
\begin{equation*}
    v_1 = \begin{bmatrix}
        -0.38 \\
        0.92
    \end{bmatrix}
\end{equation*}
So the eigenvectores associateed with the eigenvalues are.
\begin{equation} \label{EigVec}
    ...
    \end{bmatrix}
\end{equation}
The Author argues that since god is dead, no one will judge the lack of intermediates shown for the eigenvectores...please? \#PuppyEyes
}
