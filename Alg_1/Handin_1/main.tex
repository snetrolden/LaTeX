...
\begin{enumerate}
    ...
    \begin{align}
         ...
         &2 - \frac{1 \cdot (\Omega+1)^2 + \Omega \cdot 1}{\Omega (\Omega + 1)^2} \\
         &2 - \frac{(\Omega + 1)^2+\Omega}{\Omega(\Omega + 1)^2} \\
         &2 - \frac{\Omega^2 + 2\Omega + 1 + \Omega}{\Omega(\Omega + 1)^2} \\
         &2 - \frac{\Omega^2 + \Omega}{\Omega(\Omega + 1)^2} - \frac{2\Omega + 1}{\Omega(\Omega + 1)^2} \\
         &2 - \frac{\Omega(\Omega + 1)}{\Omega(\Omega + 1)^2} - \frac{2\Omega + 1}{\Omega(\Omega + 1)^2} \\
         &2 - \frac{1}{\Omega + 1} - \frac{2\Omega + 1}{\Omega(\Omega + 1)^2}
    \end{align}
